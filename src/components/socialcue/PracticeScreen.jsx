...
import { ArrowRight, MessageCircle, Ear, Users, Zap, Mic, Volume2, ChevronLeft } from 'lucide-react';
import ElevenLabsVoiceOrb from '../ElevenLabsVoiceOrb';
import { getTimingForGrade } from '../../content/training/aibehaviorconfig';

function PracticeScreen({ onNavigate, darkMode, setActiveScreen }) {
  ...
  const voiceTopics = [
    {
      ...
      title: 'Say Hi at Lunch',
      description: 'Start a conversation with a new student sitting alone.',
      gradeBand: '6-8',
      scenario: {
        id: 'conversation-lunch',
        title: 'Starting a conversation with a new student at lunch',
        description: 'You notice a new student sitting alone at lunch. Practice a friendly greeting and keep the chat going.',
        category: 'starting-conversation',
        aiRole: 'classmate'
      }
    },
    {
      id: 'conversation-locker',
      category: 'conversation',
      title: 'Locker Chat',
      description: 'Greet someone at their locker and ask about their day.',
      gradeBand: '6-8',
      scenario: {
        id: 'conversation-locker',
        title: 'Starting a conversation with someone at their locker',
        description: 'You want to start talking to a classmate at their locker before class begins.',
        category: 'starting-conversation',
        aiRole: 'classmate'
      }
    },
    {
      id: 'listening-story',
      category: 'listening',
      title: 'Friend Sharing a Story',
      description: 'Practice active listening while a friend talks about their weekend.',
      gradeBand: '6-8',
      scenario: {
        id: 'listening-story',
        title: 'Listening to a friend share a story',
        description: 'A friend is telling you about their weekend adventure. Practice showing you are really listening.',
        category: 'paying-attention',
        aiRole: 'friend'
      }
    },
    {
      id: 'asking-help-homework',
      category: 'confidence',
      title: 'Ask for Homework Help',
      description: 'Politely ask a classmate for help on a tricky question.',
      gradeBand: '6-8',
      scenario: {
        id: 'asking-help-homework',
        title: 'Asking a classmate for homework help',
        description: 'You need help understanding tonight’s math homework. Practice asking for help respectfully.',
        category: 'asking-help',
        aiRole: 'classmate'
      }
    },
    {
      id: 'joining-group-recess',
      category: 'confidence',
      title: 'Join a Recess Game',
      description: 'Join a group already playing a game at recess.',
      gradeBand: '6-8',
      scenario: {
        id: 'joining-group-recess',
        title: 'Joining a group at recess',
        description: 'A group is already playing a game at recess. Practice joining the conversation naturally.',
        category: 'joining-group',
        aiRole: 'teammate'
      }
    }
  ];
  ...
  if (showVoiceChat && selectedVoiceTopic) {
    const timingConfig = getTimingForGrade(userGradeLevel);
    console.log('🧠 timingConfig:', timingConfig);
  ...
  if (showVoiceSelection) {
    const filteredTopics = selectedCategory
      ? voiceTopics.filter((topic) => topic.category === selectedCategory)
      : voiceTopics;
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {categories.map((category, index) => (
              <div
                key={category.id}
                className={`backdrop-blur-xl border rounded-3xl overflow-hidden transition-all duration-200 group hover:scale-105 hover:shadow-2xl animate-slideUp ${
    ...
    <div className="pb-24">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-8">
        <div className="mb-12 space-y-6">
          ...
          <button
            type="button"
            className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-purple-600 via-pink-500 to-rose-500 px-8 py-10 shadow-lg hover:shadow-xl transition-all"
            onClick={() => {
